...
$(".brand-logo-slider__single").css({"height":"200px","vertically-align":"middle","line-height":"200px"});
$(".brand-logo-slider__single img").css("max-width","60%");
$(".tube-tool-layout").addClass("heading-section");

$("#btn1").trigger("click");

$("body").find(".service-details-text-wrapper").addClass("text-left p-4 heading-section");

$(".service-details-tab__navigation-wrapper .nav-link").addClass("heading-section2");
$(".service-details-tab__content-wrapper").addClass("heading-section");


  var url=window.location.pathname;
    // var res = url.substr(9, 100); // for localhost
       var res = url.substr(1, 100); // for live server
localStorage['visiting']=res;

$('.icon-menu a').each(function() {

 var getVisited=localStorage['visiting'];
      if ($(this).attr('href') == getVisited) {
...
//   // alert("yo yo");
//     // console.log(getId);
//  // localStorage['visited'] = url;
// });




    // var getVisited=localStorage['visited'];
    // // alert(getVisited);
    // $('#'+getVisited).find(".icon-box").addClass("active");
    //  $('#'+getVisited).find("h2").addClass("active");



    $("#home-video").currentTime=20;


   

    // $(window).load(function(){
    //     $(".fadeInProducts").fadeIn("slow");
    // });

    $(".socket-menu-link").hover(function(){
      // alert("fine");
      $(".socket-menu").toggleClass("open-socket-menu");
    });

// $("#trigger-products").on('click',function(){

//   $(".web-menu").show();
  
//   $("#products-menu").css({'opacity':'1','visibility':'visible'});

// });

// $("#trigger-services").on('click',function(){

//   $(".web-menu").show();
//   $(".service-menu").css({'opacity':'1','visibility':'visible'});

// });

  $("body").scrollspy({
            target: ".smooth-scroll-menu",
            offset: 200
        });
$('.smooth-scroll-menu > li > a').on('click', function(event) {
            var $anchor = $(this);
            var headerH = '75';
...
$(document).on('click',function(e) {
   ...
   {
      $(".web-menu").fadeOut('fast');

      // $(".web-menu").addClass("slideaway");
    ...
    $("#web-menu-trigger").hover(function(){
          
          $(".web-menu").show();
             $("#web-menu-trigger").toggle();
             $(".outer-logo").hide();

          });    

    // $("#web-menu-trigger2").on('click',function(){
...
// });
    ...
    var serviceSlider = new Swiper(".service-box-slider__container", {
      slidesPerView: 3,
      loop: true,
      speed: 1000,
      watchSlidesVisibility: true,
